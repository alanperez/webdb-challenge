...
1. Explain the difference between `RDBMS` and `SQL`.
 [RDBMS is relational database management system and SQL is a database language]
1. Why do tables need a `primary key`?
  [Tables need a primary key to be able to identify records. It must have a unique value for each row of data]
